...
describe("matchModuleGlob", () => {
  ...
  it("Components.* matches one level deep", () => {
    ...
    expect(matchModuleGlob("Components.*", "Components.Button.Large")).toBe(
      false,
    );
  });
  ...
  it("**.Internal.** matches internal modules at any depth", () => {
    expect(
      matchModuleGlob("**.Internal.**", "Components.Internal.Helpers"),
    ).toBe(true);
...
describe("filterModules", () => {
  it("applies include and exclude", () => {
    ...
    const modules = [
      "Components.Button",
      "Components.Internal.Helpers",
      "Main",
      "Components.Card",
    ];
    expect(filterModules(config, modules)).toEqual([
      "Components.Button",
      "Components.Card",
    ]);
  });
